...
public static class VatNumberValidator
{
    ...
    public static string? NormalizeAndValidate(string? input)
    {
        ...
        {
            throw new DomainValidationException("BTW-nummer heeft een ongeldig formaat.");
        }

        return normalized;
    }

    private static void ValidateBelgian(string normalized)
    {
        ...
        {
            throw new DomainValidationException("Belgisch BTW-nummer moet uit BE + 10 cijfers bestaan (bv. BE0123456749).");
        }

        if (digits[0] is not ('0' or '1'))
        {
            throw new DomainValidationException("Belgisch BTW-nummer moet met BE0 of BE1 beginnen.");
        }
        ...
        {
            throw new DomainValidationException("Belgisch BTW-nummer heeft een ongeldig controlegetal.");
        }
    }
}
