...
public class AttendanceService : IAttendanceService
{
        ...
        Guid employeeId, DateOnly from, DateOnly to, CancellationToken cancellationToken)
    {
        ...
        foreach (var day in allDays)
        {
            ...
            var sessionDtos = daySlices
                ...
                .Distinct()
                .OrderBy(s => s.ClockInAt)
                .Select(s => ToSessionDto(s, breaks, corrections, correctorNames, locationNames, now))
                .ToList();
    ...
    private AttendanceSessionDto ToSessionDto(
        AttendanceSession session,
        IReadOnlyList<AttendanceBreak> allBreaks,
        IReadOnlyList<AttendanceCorrection> allCorrections,
