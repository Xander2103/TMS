...
[Route("api/languages")]
public class LanguagesController : LookupControllerBase<Language>
{
    public LanguagesController(ILookupService<Language> service, ICurrentUserContext currentUser, IPermissionAuthorizationService authorization)
