    ...
    subgroups: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Doorrekenbeleid', to: '/settings/charge-policies', permissions: ['problems.approve_charge', 'incidents.manage'] },
          { label: 'Systeeminformatie', to: '/settings/system', permissions: ['system_info.view'] },
