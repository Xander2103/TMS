...
export function NewEmployeePage() {
  ...
  const extraSections: SectionDef[] = [
    ...
    },
    {
      ...
      optional: true,
      render: () => (
        <p className="placeholder-text">Documenten zijn beschikbaar na het opslaan van de medewerker.</p>
      ),
    },
    {
      id: 'bedrijfsmiddelen',
      ...
      optional: true,
      render: () => (
        <p className="placeholder-text">Bedrijfsmiddelen zijn beschikbaar na het opslaan van de medewerker.</p>
      ),
    },
  ]
