      ...
      <p className="dossier-price-total">
        ...
        {pricingIssues.length > 0 && (
          <span className="dossier-price-warning">
            ⚠ {pricingIssues.length === 1 ? '1 onderdeel vraagt aandacht' : `${pricingIssues.length} onderdelen vragen aandacht`}
          </span>
        )}
      </p>
      {dossier.orders.length === 0 && <p className="placeholder-text">Nog geen verkooplijnen.</p>}
